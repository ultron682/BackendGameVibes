        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ExperiencePoints = table.Column<int>(type: "INTEGER", nullable: true, defaultValue: 10),
                    ForumRoleId = table.Column<int>(type: "INTEGER", nullable: false, defaultValue: 1),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CpuRequirement = table.Column<string>(type: "TEXT", maxLength: 100, nullable: false),
                    GpuRequirement = table.Column<string>(type: "TEXT", maxLength: 100, nullable: false),
                    RamRequirement = table.Column<string>(type: "TEXT", maxLength: 50, nullable: false),
                    DiskRequirement = table.Column<string>(type: "TEXT", maxLength: 50, nullable: false),
                    OperatingSystemRequirement = table.Column<string>(type: "TEXT", maxLength: 100, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    UserGameVibesId = table.Column<string>(type: "TEXT", nullable: true),
                    GameId = table.Column<int>(type: "INTEGER", nullable: true),
                    GeneralScore = table.Column<double>(type: "REAL", precision: 3, scale: 2, nullable: false),
                    GraphicsScore = table.Column<double>(type: "REAL", precision: 3, scale: 2, nullable: false),
                    AudioScore = table.Column<double>(type: "REAL", precision: 3, scale: 2, nullable: false),
                    GameplayScore = table.Column<double>(type: "REAL", precision: 3, scale: 2, nullable: false),
